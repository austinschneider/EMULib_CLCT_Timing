...
typedef U32 I2O_UNIT_ID;
typedef U32 I2O_IOP_ID;
...
typedef struct
    ...
    I2O_COUNT               osVersionLow;
    I2O_COUNT               osVersionHigh;
    I2O_COUNT               osVersionTarget;
    } I2O_IOP_CONFIG_INFO;
...
extern void                     i2oIopTidMap(I2O_TID       localTid,
					     I2O_UNIT_ID   remUnitId,
					     I2O_IOP_ID    remIopId,
					     I2O_TID *     pAliasTid,
					     I2O_STATUS *  pStatus);

extern void                     i2oIopTidResolve(I2O_TID       aliasTid,
						 I2O_UNIT_ID * pRemUnitId,
						 I2O_IOP_ID *  pRemIopId,
						 I2O_TID *     pRemTid,
						 I2O_STATUS *  pStatus);
