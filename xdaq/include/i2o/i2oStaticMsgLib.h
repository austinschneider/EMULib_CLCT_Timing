/* i2oStaticMsgLib.h - static message functions header file */
...
#ifndef __INCi2oStaticMsgLibh
#define __INCi2oStaticMsgLibh

#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#include "i2o/i2oFrameLib.h"
#include "i2o/i2oEvtQLib.h"

/* privates */

typedef struct i2oStaticMsg * I2O_STATIC_MSG_ID; /* static message ID */

/* function declarations */

extern I2O_STATIC_MSG_ID i2oStaticMsgCreate (I2O_OWNER_ID       ownerId,
					     I2O_OBJ_CONTEXT    smContext,
					     I2O_FRAME *        pFrame,
					     I2O_COUNT          maxOutstanding,
					     I2O_EVENT_QUEUE_ID evtQId,
					     I2O_EVENT_PRI      smEvtPri,
					     I2O_EVENT_HANDLER  smEvtHandler,
					     I2O_STATUS *       pStatus);

extern void i2oStaticMsgSend (I2O_STATIC_MSG_ID   staticMsgId,
			      I2O_STATUS *        pStatus);
