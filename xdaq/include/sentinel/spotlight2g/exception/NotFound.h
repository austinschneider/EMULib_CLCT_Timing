...
#ifndef _sentinel_spotlight2g_exception_NotFound_h_
#define _sentinel_spotlight2g_exception_NotFound_h_
...
namespace sentinel {
	namespace spotlight2g {
		namespace exception { 
			class NotFound: public sentinel::spotlight2g::exception::Exception 
			{
				public: 
