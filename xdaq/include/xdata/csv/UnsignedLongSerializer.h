// $Id: UnsignedLongSerializer.h,v 1.2 2008/07/18 15:28:09 gutleber Exp $
...
#ifndef _xdata_csv_UnsignedLongSerializer_h_
#define _xdata_csv_UnsignedLongSerializer_h_
...
namespace xdata 
{
	namespace csv 
	{
		class UnsignedLongSerializer : public xdata::csv::ObjectSerializer  
		{	
			public:
