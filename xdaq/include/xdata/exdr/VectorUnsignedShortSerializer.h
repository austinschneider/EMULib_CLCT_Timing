// $Id: VectorUnsignedShortSerializer.h,v 1.2 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_exdr_VectorUnsignedShortSerializer_h_
#define _xdata_exdr_VectorUnsignedShortSerializer_h_
...
class VectorUnsignedShortSerializer : public xdata::exdr::ObjectSerializer  
{	
	public:
	virtual ~VectorUnsignedShortSerializer();
