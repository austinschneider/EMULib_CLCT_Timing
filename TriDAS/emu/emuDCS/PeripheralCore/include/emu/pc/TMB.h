...
public:
  ...
  inline void SetHsPretrigThresh(int hit_thresh) {
  	std::cout << "SetHsPretrigThresh: " << hit_thresh << std::endl;
  	hit_thresh_ = hit_thresh;}
  ...
  inline int  GetReadFifoNoRawHits() { return read_fifo_no_raw_hits_; }
  //
  ...
  //------------------------------------------------------------------
  //!l1adelay = [0-255] (bx)
  inline void SetL1aDelay(int l1adelay) { read_l1adelay_ = l1adelay; }
  inline int  GetL1aDelay() { return read_l1adelay_; }
  //
  //!l1a_window_size = [0-15] (bx)
  inline void SetL1aWindowSize(int l1a_window_size) { read_l1a_window_size_ = l1a_window_size; }
  inline int  GetL1aWindowSize() { return read_l1a_window_size_; }
  //
  //!tmb_l1a_internal = 1 = generate internal level 1 (overrides external)
  inline void SetInternalL1a(int tmb_l1a_internal) { read_tmb_l1a_internal_ = tmb_l1a_internal; }
  inline int  GetInternalL1a() { return read_tmb_l1a_internal_; }
  //
  //------------------------------------------------------------------
