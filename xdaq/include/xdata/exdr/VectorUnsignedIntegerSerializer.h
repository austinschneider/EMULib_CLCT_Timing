...
#ifndef _xdata_exdr_VectorUnsignedIntegerSerializer_h_
#define _xdata_exdr_VectorUnsignedIntegerSerializer_h_
...
class VectorUnsignedIntegerSerializer : public xdata::exdr::ObjectSerializer  
{	
	public:
