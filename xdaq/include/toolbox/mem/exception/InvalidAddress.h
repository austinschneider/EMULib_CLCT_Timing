// $Id: InvalidAddress.h,v 1.2 2008/07/18 15:27:35 gutleber Exp $
...
#ifndef _toolbox_mem_exception_InvalidAddress_h_
#define _toolbox_mem_exception_InvalidAddress_h_
...
namespace mem {
	namespace exception { 
		class InvalidAddress: public toolbox::mem::exception::Exception 
		{
			public: 
