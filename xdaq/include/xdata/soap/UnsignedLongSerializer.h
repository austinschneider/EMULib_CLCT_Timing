// $Id: UnsignedLongSerializer.h,v 1.3 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_soap_UnsignedLongSerializer_h_
#define _xdata_soap_UnsignedLongSerializer_h_
...
namespace xdata 
{
	namespace soap 
	{
		class UnsignedLongSerializer : public xdata::soap::ObjectSerializer  
		{	
			public:
			virtual ~UnsignedLongSerializer();
