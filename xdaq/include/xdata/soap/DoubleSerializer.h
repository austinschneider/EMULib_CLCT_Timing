// $Id: DoubleSerializer.h,v 1.3 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_soap_DoubleSerializer_h_
#define _xdata_soap_DoubleSerializer_h_
...
class DoubleSerializer : public xdata::soap::ObjectSerializer  
{	
	public:
