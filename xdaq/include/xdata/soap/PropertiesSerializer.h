// $Id: PropertiesSerializer.h,v 1.2 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_soap_PropertiesSerializer_h_
#define _xdata_soap_PropertiesSerializer_h_
...
class PropertiesSerializer : public xdata::soap::ObjectSerializer 
{
	public:
	virtual ~PropertiesSerializer();
