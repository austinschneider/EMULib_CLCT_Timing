// $Id: PropertiesSerializer.h,v 1.2 2008/07/18 15:28:09 gutleber Exp $
...
#ifndef _xdata_csv_PropertiesSerializer_h_
#define _xdata_csv_PropertiesSerializer_h_
...
class PropertiesSerializer : public xdata::csv::ObjectSerializer 
{
	public:
