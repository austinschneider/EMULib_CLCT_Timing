// $Id: VectorFloatSerializer.h,v 1.2 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_exdr_VectorFloatSerializer_h_
#define _xdata_exdr_VectorFloatSerializer_h_
...
class VectorFloatSerializer : public xdata::exdr::ObjectSerializer  
{	
	public:
	virtual ~VectorFloatSerializer();
