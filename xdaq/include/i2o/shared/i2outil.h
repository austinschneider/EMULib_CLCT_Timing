...
#define I2OUTIL_REV 2_0_0  /* I2OUtil header file revision string */
...
#define    I2O_UTIL_CLAIM_MODIFY                       0x11
...
#define    I2O_CLAIM_FLAGS_CRITICAL_DEVICE             0x0040
...
/* UtilClaimModify Function Message Frame structure. */

typedef struct _I2O_UTIL_CLAIM_MODIFY_MESSAGE {
    I2O_MESSAGE_FRAME          StdMessageFrame;
    I2O_TRANSACTION_CONTEXT    TransactionContext;
    U16                        ClaimFlags;
    U8                         reserved;
    U8                         ClaimType;
} I2O_UTIL_CLAIM_MODIFY_MESSAGE, *PI2O_UTIL_CLAIM_MODIFY_MESSAGE;
