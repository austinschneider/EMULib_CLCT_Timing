...
#ifndef _xdata_exdr_TimeValSerializer_h_
#define _xdata_exdr_TimeValSerializer_h_
...
namespace xdata 
{
	namespace exdr 
	{
		class TimeValSerializer : public xdata::exdr::ObjectSerializer  
		{	
			public:
			...
			(
				xdata::exdr::Serializer * serializer,
				xdata::Serializable * serializable,
				xdata::exdr::InputStreamBuffer * sbu
			) 
			throw (xdata::exception::Exception);
		};
	}
