// $Id: InternalError.h,v 1.2 2008/07/18 15:27:37 gutleber Exp $
...
#ifndef _toolbox_task_exception_InternalError_h_
#define _toolbox_task_exception_InternalError_h_
...
namespace toolbox 
{
	namespace task 
	{
		namespace exception 
		{ 
			class InternalError: public toolbox::task::exception::Exception 
			{
				public: 
