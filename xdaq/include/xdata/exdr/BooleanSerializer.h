// $Id: BooleanSerializer.h,v 1.4 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_exdr_BooleanSerializer_h_
#define _xdata_exdr_BooleanSerializer_h_
...
class BooleanSerializer : public xdata::exdr::ObjectSerializer  
{	
	public:
