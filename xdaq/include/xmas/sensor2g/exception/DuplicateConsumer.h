...
#ifndef _xmas_sensor2g_exception_DuplicateConsumer_h_
#define _xmas_sensor2g_exception_DuplicateConsumer_h_
...
namespace xmas {
	namespace sensor2g {
		namespace exception { 
			class DuplicateConsumer: public xmas::sensor2g::exception::Exception 
			{
				public: 
