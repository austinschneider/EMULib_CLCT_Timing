...
#define RUBUILDERFU_VERSION_MAJOR 1
#define RUBUILDERFU_VERSION_MINOR 15
#define RUBUILDERFU_VERSION_PATCH 1
#define RUBUILDERFU_PREVIOUS_VERSIONS "1.11.0,1.12.0,1.12.1,1.13.0,1.14.0,1.14.1,1.15.0"
