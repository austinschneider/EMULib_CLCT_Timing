...
#ifndef _xdata_exdr_VectorInteger32Serializer_h_
#define _xdata_exdr_VectorInteger32Serializer_h_
...
class VectorInteger32Serializer : public xdata::exdr::ObjectSerializer  
{	
	public:
