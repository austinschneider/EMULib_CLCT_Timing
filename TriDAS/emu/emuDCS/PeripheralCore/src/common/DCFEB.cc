...
void DCFEB::Set_TMB_TX_MODE(char mode){
...
void DCFEB::Set_TMB_TX_MODE_ShiftLayers(char hs[6]){
...
void DCFEB::Set_TMB_TX_MODE_Layer_Mask(char layer_mask){
