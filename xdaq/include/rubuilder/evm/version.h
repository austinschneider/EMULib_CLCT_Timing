...
#define RUBUILDEREVM_VERSION_MAJOR 4
#define RUBUILDEREVM_VERSION_MINOR 3
#define RUBUILDEREVM_VERSION_PATCH 2
#define RUBUILDEREVM_PREVIOUS_VERSIONS "4.3.0,4.3.1"
