...
#ifndef _sentinel_spotlight_exception_FailedToClose_h_
#define _sentinel_spotlight_exception_FailedToClose_h_
...
namespace sentinel {
	namespace spotlight {
		namespace exception { 
			class FailedToClose: public sentinel::spotlight::exception::Exception 
			{
				public: 
