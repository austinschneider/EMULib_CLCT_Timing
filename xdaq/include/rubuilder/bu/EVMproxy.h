...
namespace rubuilder { namespace bu { // namespace rubuilder::bu
  ...
  public:
     ...
     * to the EVM
     */
    void sendEvtIdRqstAndOrRelease(const EvtIdRqstAndOrRelease&);
  ...
  private:
    ...
    uint32_t packEvtIdRqstsAndOrReleasesMsg(const EvtIdRqstAndOrRelease&);
    ...
    mutable boost::mutex evtIdRqstsAndOrReleasesMutex_;
    ...
    mutable boost::mutex rqstAndOrReleaseMonitoringMutex_;
