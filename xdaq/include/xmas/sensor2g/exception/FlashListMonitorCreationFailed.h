...
#ifndef _xmas_sensor2g_exception_FlashListMonitorCreationFailed_h_
#define _xmas_sensor2g_exception_FlashListMonitorCreationFailed_h_
...
namespace xmas {
	namespace sensor2g {
		namespace exception { 
			class FlashListMonitorCreationFailed: public xmas::sensor2g::exception::Exception 
			{
				public: 
