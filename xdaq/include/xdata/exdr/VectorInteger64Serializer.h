...
#ifndef _xdata_exdr_VectorInteger64Serializer_h_
#define _xdata_exdr_VectorInteger64Serializer_h_
...
class VectorInteger64Serializer : public xdata::exdr::ObjectSerializer  
{	
	public:
