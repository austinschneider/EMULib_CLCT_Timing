// $Id: ConfigurationError.h,v 1.4 2008/07/18 15:28:03 gutleber Exp $
...
#ifndef _xdaq_exception_ConfigurationError_h_
#define _xdaq_exception_ConfigurationError_h_

#include "xdaq/exception/Exception.h"

namespace xdaq {
	namespace exception { 
		class ConfigurationError: public xdaq::exception::Exception 
		{
			public: 
