// $Id: ConsumerNotFound.h,v 1.2 2008/07/18 15:28:30 gutleber Exp $
...
#ifndef _xmas_sensor_exception_ConsumerNotFound_h_
#define _xmas_sensor_exception_ConsumerNotFound_h_
...
namespace xmas {
	namespace sensor {
		namespace exception { 
			class ConsumerNotFound: public xmas::sensor::exception::Exception 
			{
				public: 
