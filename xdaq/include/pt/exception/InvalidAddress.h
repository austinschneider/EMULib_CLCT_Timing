// $Id: InvalidAddress.h,v 1.4 2008/07/18 15:27:18 gutleber Exp $
...
#ifndef _pt_exception_InvalidAddress_h_
#define _pt_exception_InvalidAddress_h_

#include "pt/exception/Exception.h"

namespace pt {
	namespace exception { 
		class InvalidAddress: public pt::exception::Exception 
		{
			public: 
