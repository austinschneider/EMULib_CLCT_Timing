...
public:
  ...
  void Set_TMB_TX_MODE(int cfeb_number, char mode);
	void Set_TMB_TX_MODE_ShiftLayers(int cfeb_number, char hs[6]);
	void Set_TMB_TX_MODE_ShiftLayers(int cfeb_number, int hs[6]);
	void Set_TMB_TX_MODE_Layer_Mask(int cfeb_number, char layer_mask);
