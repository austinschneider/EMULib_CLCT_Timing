// $Id: FloatSerializer.h,v 1.5 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_exdr_FloatSerializer_h_
#define _xdata_exdr_FloatSerializer_h_
...
class FloatSerializer : public xdata::exdr::ObjectSerializer  
{	
	public:
	virtual ~FloatSerializer();
