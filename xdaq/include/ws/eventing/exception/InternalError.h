// $Id: InternalError.h,v 1.3 2008/07/18 15:27:50 gutleber Exp $
...
#ifndef _ws_eventing_exception_InternalError_h_
#define _ws_eventing_exception_InternalError_h_
...
namespace ws {
	namespace eventing {
		namespace exception { 
			class InternalError: public ws::eventing::exception::Exception 
			{
				public: 
