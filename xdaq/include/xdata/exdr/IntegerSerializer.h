// $Id: IntegerSerializer.h,v 1.5 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_exdr_IntegerSerializer_h_
#define _xdata_exdr_IntegerSerializer_h_
...
class IntegerSerializer : public xdata::exdr::ObjectSerializer  
{	
	public:
