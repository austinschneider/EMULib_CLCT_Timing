...
#ifndef _b2in_utils_EventingDialup_h_
#define _b2in_utils_EventingDialup_h_
...
namespace b2in 
{
	namespace utils
	{
		class EventingDialup: public xdaq::Object, public toolbox::task::TimerListener
	 	{

			public:

			EventingDialup (xdaq::Application * owner, const std::string & publishGroup, const std::string & brokerURL,
			...
			public:
				BrokerAsynchronousExceptionNotification(b2in::utils::EventingDialup& parent) : parent_(parent)
				{
				}
			...
			private:
				b2in::utils::EventingDialup& parent_;
			...
			public:
				EventingAsynchronousExceptionNotification(b2in::utils::EventingDialup& parent) : parent_(parent)
				{
				}
