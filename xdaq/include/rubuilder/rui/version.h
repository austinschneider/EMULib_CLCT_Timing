...
#define RUBUILDERRUI_VERSION_MAJOR 1
#define RUBUILDERRUI_VERSION_MINOR 14
#define RUBUILDERRUI_VERSION_PATCH 2
#define RUBUILDERRUI_PREVIOUS_VERSIONS "1.11.0,1.12.0,1.12.1,1.13.0,1.14.0,1.14.1"
