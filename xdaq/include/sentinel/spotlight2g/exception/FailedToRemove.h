...
#ifndef _sentinel_spotlight2g_exception_FailedToRemove_h_
#define _sentinel_spotlight2g_exception_FailedToRemove_h_
...
namespace sentinel {
	namespace spotlight2g {
		namespace exception { 
			class FailedToRemove: public sentinel::spotlight2g::exception::Exception 
			{
				public: 
