...
private:
  ...
  void clearedEventIdFIFOWebPage(xgi::Input*, xgi::Output*);
  void freeEventIdFIFOWebPage(xgi::Input*, xgi::Output*);
  void triggerFIFOWebPage(xgi::Input*, xgi::Output*);
  void pairFIFOWebPage(xgi::Input*, xgi::Output*);
  ...
  void releasedEventIdFIFOWebPage(xgi::Input*, xgi::Output*);
