...
class EventTable;
  ...
  public:
    ...
    /**
     * Callback for end-of-lumisection I2O message received from EVM
     */
    void lumisectionI2Ocallback(toolbox::mem::Reference*);
  ...
  private:
    ...
    mutable boost::mutex participatingFUsMutex_;
    ...
    mutable boost::mutex discardMonitoringMutex_;
