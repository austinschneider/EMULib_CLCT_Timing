...
/* frame extension macros */

#define I2O_FRAME_TO_EXTENSION(pFrame)  ((void *)((U32)pFrame - 8))
#define I2O_EXTENSION_TO_FRAME(pExt)    ((I2O_FRAME *)((U32)pExt + 8))
...
extern void     		i2oFrameSendX (I2O_FRAME*  pFrame,
                                               I2O_DTAG    dtag,
                                               I2O_STATUS* pStatus);

extern U32                      i2oInitiatorContextBuild
                                             (I2O_EVENT_HANDLER	func,
                                              I2O_EVENT_PRI	pri,
                                              I2O_STATUS*	pStatus);

extern I2O_INITIATOR_CONTEXT	i2oInitiatorContextBuildQ
                                             (I2O_EVENT_HANDLER	 func,
                                              I2O_EVENT_PRI	 pri,
					      I2O_EVENT_QUEUE_ID evtQId,
                                              I2O_STATUS*	 pStatus);

extern I2O_SIZE                 i2oFrameMaxSizeGet (I2O_TID     tid,
						    I2O_STATUS*	pStatus);
