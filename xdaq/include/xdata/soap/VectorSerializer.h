// $Id: VectorSerializer.h,v 1.3 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_soap_VectorSerializer_h_
#define _xdata_soap_VectorSerializer_h_
...
class VectorSerializer : public xdata::soap::ObjectSerializer 
{	
	public:
	...
	void import (xdata::Serializer * serializer,  Serializable * serializable, DOMNode* targetNode) throw (xdata::exception::Exception);
};
