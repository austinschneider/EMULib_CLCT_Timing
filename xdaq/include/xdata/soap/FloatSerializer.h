// $Id: FloatSerializer.h,v 1.3 2008/07/18 15:28:11 gutleber Exp $
...
#ifndef _xdata_soap_FloatSerializer_h_
#define _xdata_soap_FloatSerializer_h_
...
class FloatSerializer : public xdata::soap::ObjectSerializer  
{	
	public:
