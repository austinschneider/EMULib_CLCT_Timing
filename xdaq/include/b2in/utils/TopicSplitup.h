...
#ifndef _b2in_utils_TopicSplitup_h_
#define _b2in_utils_TopicSplitup_h_
...
namespace b2in 
{
	namespace utils
	{
		class TopicSplitup : public b2in::utils::MessengerCacheListener, public xdaq::Object, public toolbox::task::TimerListener
		{
			public:

			TopicSplitup (xdaq::Application * owner, const std::string & brokerURL, const std::string & networkName, toolbox::TimeInterval interval,
				std::list<std::string> & names) 
				throw(b2in::utils::exception::Exception);

			virtual ~TopicSplitup (); 
