...
namespace rubuilder { namespace evm { // namespace rubuilder::evm
  ...
  public:
    ...
    /**
     * Print the content of the free event id FIFO as HTML snipped
     */
    inline void printFreeEventIdFIFO(xgi::Output* out)
    { freeEventIdFIFO_.printVerticalHtml(out); }
    ...
    /**
     * Populates the free event id FIFO with all the event ids
     * in the RU builder.
     */
    void populateFreeEventIdFIFO();
    ...
    /**
     * Stop requesting (local) triggers;
     */
    void stopTriggers()
    { requestTriggers_ = false; }
  ...
  private:
    ...
    typedef utils::OneToOneQueue<uint32_t> FreeEventIdFIFO;
    FreeEventIdFIFO freeEventIdFIFO_;

    volatile bool doProcessing_;
    volatile bool processActive_;
    volatile bool requestTriggers_;
    volatile bool sendOldMessagesActionPending_;
    mutable boost::mutex sendOldMessagesActionPendingMutex_;
