// $Id: QueueFull.h,v 1.2 2008/07/18 15:27:20 gutleber Exp $
...
#ifndef _pt_tcp_exception_QueueFull_h_
#define _pt_tcp_exception_QueueFull_h_
...
namespace tcp {
	namespace exception { 
		class QueueFull: public pt::tcp::exception::Exception 
		{
			public: 
