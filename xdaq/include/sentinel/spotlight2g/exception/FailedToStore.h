...
#ifndef _sentinel_spotlight2g_exception_FailedToStore_h_
#define _sentinel_spotlight2g_exception_FailedToStore_h_
...
namespace sentinel {
	namespace spotlight2g {
		namespace exception { 
			class FailedToStore: public sentinel::spotlight2g::exception::Exception 
			{
				public: 
