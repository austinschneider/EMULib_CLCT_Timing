// $Id: FloatSerializer.h,v 1.2 2008/07/18 15:28:09 gutleber Exp $
...
#ifndef _xdata_csv_FloatSerializer_h_
#define _xdata_csv_FloatSerializer_h_
...
class FloatSerializer : public xdata::csv::ObjectSerializer  
{	
	public:
