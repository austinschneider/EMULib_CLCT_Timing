...
#ifndef _b2in_utils_EventingPoolSubscriber_h_
#define _b2in_utils_EventingPoolSubscriber_h_
...
namespace b2in 
{
	namespace utils
	{
		class EventingPoolSubscriber : public xdaq::Object, public toolbox::task::TimerListener
		{
			public:

			EventingPoolSubscriber (xdaq::Application * owner, const std::string & brokerURL, const std::string & networkName, toolbox::TimeInterval scanPeriod,
			...
			virtual ~EventingPoolSubscriber (); 
			...
			public:
				BrokerAsynchronousExceptionNotification(b2in::utils::EventingPoolSubscriber& parent) : parent_(parent)
				{
				}
				void asynchronousExceptionNotification(xcept::Exception& e);
			private:
				b2in::utils::EventingPoolSubscriber& parent_;
			...
			public:
				EventingAsynchronousExceptionNotification(b2in::utils::EventingPoolSubscriber& parent) : parent_(parent)
				{
				}
				void asynchronousExceptionNotification(xcept::Exception& e);
			private:
