// $Id: BagSerializer.h,v 1.3 2008/07/18 15:28:09 gutleber Exp $
...
#ifndef _xdata_csv_BagSerializer_h_
#define _xdata_csv_BagSerializer_h_
...
class BagSerializer : public xdata::csv::ObjectSerializer 
{	
	public:
