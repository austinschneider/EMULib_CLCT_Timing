/**
 *     @class JTAGSVFCommandFactoryTRST
 *
 *     @short JTAG SVF Command Factory for TRST Command.
 *            
 *       
 *       @see
...
#ifndef jal_JTAGSVFCommandFactoryTRST_H
#define jal_JTAGSVFCommandFactoryTRST_H
...
namespace jal {
  ...
  class JTAGSVFCommandFactoryTRST : public JTAGSVFCommandFactory {
  public:
    /// constructor
    JTAGSVFCommandFactoryTRST() {};
