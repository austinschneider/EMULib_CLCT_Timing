/* i2oIndirectLib.h - memory indirection library header file */
...
#ifndef __INCi2oIndirectLibh
#define __INCi2oIndirectLibh
...
typedef struct i2oIndirect* I2O_INDIRECT_ID;

typedef U32 I2O_INDIR_FLAGS;

/* defines */

/* Indirect mapping flags values */

#define I2O_INDIRECT_READ         0x01
#define I2O_INDIRECT_CONTEXT_COPY 0x02
#define I2O_INDIRECT_ABORT        0x04
#define I2O_INDIRECT_NO_EVENT     0x08

/* function declarations */

extern I2O_INDIRECT_ID i2oIndirectCreate (I2O_OWNER_ID       ownerId,
                                          I2O_EVENT_QUEUE_ID evtQId,
                                          I2O_EVENT_PRI      evtPri,
                                          I2O_STATUS *       pStatus);

extern void i2oIndirectMap (I2O_INDIRECT_ID   indirectId,
                            I2O_SG_ELEMENT *  remoteList,
                            I2O_SGL_MARK      mark,
                            I2O_SIZE          maxBytes,
                            I2O_SG_ELEMENT *  localList,
                            I2O_SIZE          listSize,
                            I2O_INDIR_FLAGS   indirectFlags,
                            I2O_OBJ_CONTEXT   mapContext,
                            I2O_EVENT_HANDLER mapEvtHandler,
                            I2O_SIZE *        mappedBytes,
                            I2O_STATUS *      pStatus);

extern void i2oIndirectUnmap (I2O_INDIRECT_ID   indirectId,
                              I2O_INDIR_FLAGS   indirectFlags,
                              I2O_OBJ_CONTEXT   unmapContext,
                              I2O_EVENT_HANDLER unmapEvtHandler,
                              I2O_STATUS *      pStatus);
