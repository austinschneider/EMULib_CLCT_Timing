...
#define TAILMEM 100
#define TAILPOS  80
//#define SKB_EXTRA 12 // this is the old value from direct DDU/ Jianhui's box I get 14
#define SKB_EXTRA 14 // skb->len is not the actual lenght. skb->len+SKB_EXTRA is.
